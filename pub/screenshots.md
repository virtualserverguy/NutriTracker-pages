...
*Quick food logging with categories for easy navigation. Tap any item to log it instantly.*

### Set Goals

![Goals Screenshot](/assets/images/screenshots/iphone-goals.png)
*Customize your hourly targets for carbs, sodium, and water based on your needs and race conditions.*
...
Color-coded progress bars make it easy to see if you’re hitting your targets:
...
Designed for speed when you’re tired and moving. One tap logs an item with automatic timestamp.

### 📊 Detailed Analytics

Hourly breakdown shows consumption patterns throughout your run, helping you optimize your fueling strategy.
...
Want to show off FuelFlow in your race reports or social media? Here’s how to capture screenshots:

### iPhone

1. Press **Volume Up + Side Button** simultaneously
1. Screenshot saves to Photos
